...
import { mockTickets, mockMessages, mockDocuments, mockTaxOrganizer } from '@/lib/mock-data';
import { TICKET_STAGES } from '@/lib/constants';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { ArrowLeft, FileText, MessageCircle, Download, Upload, Send } from 'lucide-react';
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <input type="text" defaultValue={ticket.clientName} className="w-full px-3 py-2 border rounded-lg mt-1" />
                  </div>
                  <div>
                    <label className="text-sm text-muted-foreground">SSN</label>
                    <input type="text" placeholder="xxx-xx-1234" className="w-full px-3 py-2 border rounded-lg mt-1" />
                  </div>
                  <div>
                    <label className="text-sm text-muted-foreground">Date of Birth</label>
                    <input type="date" className="w-full px-3 py-2 border rounded-lg mt-1" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="number" defaultValue={0} className="w-full px-3 py-2 border rounded-lg mt-1" />
                  </div>
                  <div className="flex gap-2 justify-end pt-4">
                    <Button variant="outline" size="sm">Cancel</Button>
                    <Button size="sm">Save</Button>
                    <Button size="sm" variant="outline">Next Section</Button>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Button className="w-full" variant="default">Approve Draft</Button>
                ...
                <div>
                  ...
                  <textarea placeholder="Client comments..." className="w-full px-3 py-2 border rounded-lg mt-2 text-sm resize-none" rows={4} />
                </div>
              </CardContent>
            </Card>
          </div>
