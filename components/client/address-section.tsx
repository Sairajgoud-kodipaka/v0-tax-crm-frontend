    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-x-4 gap-y-5 sm:grid-cols-2">
        <div className="space-y-2 sm:col-span-2">
          ...
          <Input id="addr-line1" name="addr-line1" autoComplete="address-line1" className="bg-background" />
        </div>

        <div className="space-y-2 sm:col-span-2">
          <Label htmlFor="addr-line2">Address line 2</Label>
          <Input id="addr-line2" name="addr-line2" autoComplete="address-line2" className="bg-background" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="addr-city" name="addr-city" autoComplete="address-level2" className="bg-background" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <select id="addr-state" name="addr-state" defaultValue="" className={selectClassName}>
        ...
        <div className="space-y-2">
          ...
          <Input id="addr-zip" name="addr-zip" autoComplete="postal-code" className="bg-background" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="addr-country" name="addr-country" autoComplete="country-name" className="bg-background" />
        </div>
