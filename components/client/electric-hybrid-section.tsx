...
export function ElectricHybridSection() {
  const formId = useId();
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        >
          <div className="flex items-center justify-between border-b border-border bg-card px-4 py-3">
            <DialogTitle className="text-base font-semibold text-foreground">Add Electric Vehicle</DialogTitle>
            <DialogClose asChild>
              <button
                type="button"
            ...
            <div className="space-y-5">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="ev-year" name="ev-year" className="bg-background" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="ev-make">
                    <Req>Vehicle make</Req>
                  </Label>
                  <Input id="ev-make" name="ev-make" className="bg-background" required />
                </div>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="ev-model" name="ev-model" className="bg-background" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="ev-id">
                    <Req>Vehicle id</Req>
                  </Label>
                  <Input id="ev-id" name="ev-id" className="bg-background" required />
                </div>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <DatePicker id="ev-purchase-date" name="ev-purchase-date" className="bg-background" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="ev-cost">
                    <Req>Vehicle cost</Req>
                  </Label>
                  <Input id="ev-cost" name="ev-cost" className="bg-background" required />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="ev-comments">Comments</Label>
                <Textarea id="ev-comments" name="ev-comments" className="min-h-[100px] resize-y bg-background" />
              </div>
