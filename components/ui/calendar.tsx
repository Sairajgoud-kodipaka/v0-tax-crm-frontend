  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          'rounded-md bg-muted font-medium text-foreground data-[selected=true]:rounded-none',
  ...
  return (
    <Button
      ...
      className={cn(
        defaultClassNames.day,
        className,
        /* Defaults first; these win in merge — high-contrast fills for every theme */
        ...
        'data-[range-middle=true]:bg-muted data-[range-middle=true]:text-foreground data-[range-middle=true]:[&>span]:opacity-100',
        ...
        'data-[selected-single=true]:[&>span]:text-background data-[range-start=true]:[&>span]:text-background data-[range-end=true]:[&>span]:text-background data-[selected-single=true]:[&>span]:opacity-100',
